...
class DashboardApp:
    ...
    def crear_pestana_alumnos(self):
        ...
        # Lista de alumnos
        self.lista_alumnos = ttk.Treeview(frame, columns=("ID", "Nombre", "Apellido", "Correo"), show='headings')
        self.lista_alumnos.heading("ID", text="ID")
    ...
    def cargar_lista_pagos(self):
        ...
        for pago in self.pagos:
            if 'id_pago' in pago and 'id_alumno' in pago and 'monto' in pago and 'fecha' in pago:
                self.lista_pagos.insert('', 'end',
                                        values=(pago['id_pago'], pago['id_alumno'], pago['monto'], pago['fecha']))
            else:
